...
package htgd.com.radiocontrol.visualaudio.encode;
...
public class NV21Convertor {
    ...
    private static final Object CONVERTOR_LOCK = new Object();

    private int mSliceHeight, mHeight, mStride, mWidth, mSize, mYPadding;
    private boolean mPlanar, mPanesReversed = false, mIsRelease;
